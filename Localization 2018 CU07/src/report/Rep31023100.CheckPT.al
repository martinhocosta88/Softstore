report 31023100 "Check(PT)"
{
                  ...
                  CASE BalancingType OF
                    ...
                    BalancingType::Customer:
                      BEGIN
                        ...
                        //IF Cust."Privacy Blocked" THEN                   //MSC
                    ...
                    BalancingType::Vendor:
                      ...
                      //  IF Vend."Privacy Blocked" THEN                  //MSC
    ...
    var
        Text000 : TextConst ENU='Preview is not allowed.',PTG='Não é permitido pré-visualizar.';
        Text001 : TextConst ENU='Last Check No. must be filled in.',PTG='Últ. N.º Cheque deve estar preenchido.';
        Text002 : TextConst ENU='Filters on %1 and %2 are not allowed.',PTG='Filtros em %1 e %2 não são permitidos.';
        Text003 : TextConst ENU='XXXXXXXXXXXXXXXX',PTG='XXXXXXXXXXXXXXXX';
        Text004 : TextConst ENU='must be entered.',PTG='deve ser introduzido.';
        Text005 : TextConst ENU='The Bank Account and the General Journal Line must have the same currency.',PTG='A Conta Bancária e a Linha do Diário Geral devem ter a mesma divisa.';
        Text008 : TextConst ENU='Both Bank Accounts must have the same currency.',PTG='Ambas as Contas Bancárias devem ter a mesma divisa.';
        Text010 : TextConst ENU='XXXXXXXXXX',PTG='XXXXXXXXXX';
        Text011 : TextConst ENU='XXXX',PTG='XXXX';
        Text012 : TextConst ENU='XX.XXXXXXXXXX.XXXX',PTG='XX.XXXXXXXXXX.XXXX';
        Text013 : TextConst ENU='%1 already exists.',PTG='%1 já existe.';
        Text014 : TextConst ENU='Check for %1 %2',PTG='Check for %1 %2';
        Text016 : TextConst ENU='In the Check report, One Check per Vendor and Document No.\must not be activated when Applies-to ID is specified in the journal lines.',PTG='No mapa de Cheques,Um Cheque por Fornec. e Nº Documento\não deve estar ativo quando a Liq.-por Nº Mov. está indicada nas linhas do diário.';
        Text019 : TextConst ENU='Total',PTG='Total';
        Text020 : TextConst ENU='The total amount of check %1 is %2. The amount must be positive.',PTG='O total do cheque %1 é %2. O Valor deve ser positivo.';
        Text021 : TextConst ENU='VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID',PTG='NULO NULO NULO NULO NULO NULO NULO NULO NULO NULO NULO NULO NULO NULO';
        Text022 : TextConst ENU='NON-NEGOTIABLE',PTG='NÃO-NEGOCIAVEL';
        Text023 : TextConst ENU='Test print',PTG='Verificar Impressão';
        Text024 : TextConst ENU='XXXX.XX',PTG='XXXX.XX';
        Text025 : TextConst ENU='XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',PTG='XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
        Text026 : TextConst ENU='ZERO',PTG='ZERO';
        Text027 : TextConst ENU='HUNDRED',PTG='CEM';
        Text028 : TextConst ENU='AND',PTG='E';
        Text029 : TextConst ENU='%1 results in a written number that is too long.',PTG='%1 resulta num número escrito demasiado longo.';
        Text030 : TextConst ENU=' is already applied to %1 %2 for customer %3.',PTG=' já foi aplicado a %1 %2 para o cliente %3.';
        Text031 : TextConst ENU=' is already applied to %1 %2 for vendor %3.',PTG=' já liquidou a %1 %2 para fornecedor %3.';
        Text032 : TextConst ENU='ONE',PTG='UM';
        Text033 : TextConst ENU='TWO',PTG='DOIS';
        Text034 : TextConst ENU='THREE',PTG='TRÊS';
        Text035 : TextConst ENU='FOUR',PTG='QUATRO';
        Text036 : TextConst ENU='FIVE',PTG='CINCO';
        Text037 : TextConst ENU='SIX',PTG='SEIS';
        Text038 : TextConst ENU='SEVEN',PTG='SETE';
        Text039 : TextConst ENU='EIGHT',PTG='OITO';
        Text040 : TextConst ENU='NINE',PTG='NOVE';
        Text041 : TextConst ENU='TEN',PTG='DEZ';
        Text042 : TextConst ENU='ELEVEN',PTG='ONZE';
        Text043 : TextConst ENU='TWELVE',PTG='DOZE';
        Text044 : TextConst ENU='THIRTEEN',PTG='TREZE';
        Text045 : TextConst ENU='FOURTEEN',PTG='CATORZE';
        Text046 : TextConst ENU='FIFTEEN',PTG='QUINZE';
        Text047 : TextConst ENU='SIXTEEN',PTG='DEZASSEIS';
        Text048 : TextConst ENU='SEVENTEEN',PTG='DEZASSETE';
        Text049 : TextConst ENU='EIGHTEEN',PTG='DEZOITO';
        Text050 : TextConst ENU='NINETEEN',PTG='DEZANOVE';
        Text051 : TextConst ENU='TWENTY',PTG='VINTE';
        Text052 : TextConst ENU='THIRTY',PTG='TRINTA';
        Text053 : TextConst ENU='FORTY',PTG='QUARENTA';
        Text054 : TextConst ENU='FIFTY',PTG='CINQUENTA';
        Text055 : TextConst ENU='SIXTY',PTG='SESSENTA';
        Text056 : TextConst ENU='SEVENTY',PTG='SETENTA';
        Text057 : TextConst ENU='EIGHTY',PTG='OITENTA';
        Text058 : TextConst ENU='NINETY',PTG='NOVENTA';
        Text059 : TextConst ENU='THOUSAND',PTG='MIL';
        Text060 : TextConst ENU='MILLION',PTG='MILHÃO';
        Text061 : TextConst ENU='BILLION',PTG='BILIÃO';
        ...
        i : Integer;
        Text062 : TextConst ENU='G/L Account,Customer,Vendor,Bank Account',PTG='Conta C/G,Cliente,Fornecedor,Conta Bancária';
        CurrencyCode2 : Code[10];
        NetAmount : Text[30];
        LineAmount2 : Decimal;
        Text063 : TextConst ENU='Net Amount %1',PTG='Valor Liquido %1';
        Text064 : TextConst ENU='%1 must not be %2 for %3 %4.',PTG='%1 não pode ser %2 para %3 %4.';
        Text065 : TextConst ENU='Subtotal',PTG='Subtotal';
        CheckNoTextCaptionLbl : TextConst ENU='Check No.',PTG='Nº Cheque';
        LineAmountCaptionLbl : TextConst ENU='Net Amount',PTG='Valor liquido';
        LineDiscountCaptionLbl : TextConst ENU='Discount',PTG='Desconto';
        AmountCaptionLbl : TextConst ENU='Amount',PTG='Valor';
        DocNoCaptionLbl : TextConst ENU='Document No.',PTG='Nº Documento';
        DocDateCaptionLbl : TextConst ENU='Document Date',PTG='Data Documento';
        CurrencyCodeCaptionLbl : TextConst ENU='Currency Code',PTG='Cód. Divisa';
        YourDocNoCaptionLbl : TextConst ENU='Your Doc. No.',PTG='N.º Documento';
        TransportCaptionLbl : TextConst ENU='Transport',PTG='Transporte';
        "//--soft-global--//" : Integer;
        ...
        Text31022890 : TextConst ENU='<decimals>',PTG='<decimals>';
        Text31022891 : TextConst ENU='MILLIONS ',PTG='MILHÕES ';
        Text31022892 : TextConst ENU='ONE MILLION ',PTG='UM MILHÃO ';
        Text31022893 : TextConst ENU='ONE THOUSAND ',PTG='MIL ';
        Text31022894 : TextConst ENU='ONE HUNDRED ',PTG='CEM ';
        Text31022895 : TextConst ENU='ONE HUNDRED ',PTG='CENTO ';
        Text31022896 : TextConst ENU='TWO HUNDRED ',PTG='DUZENTOS ';
        Text31022897 : TextConst ENU='THREE HUNDRED ',PTG='TREZENTOS ';
        Text31022898 : TextConst ENU='FOUR HUNDRED ',PTG='QUATROCENTOS ';
        Text31022899 : TextConst ENU='FIVE HUNDRED ',PTG='QUINHENTOS ';
        Text31022900 : TextConst ENU='SIX HUNDRED ',PTG='SEISCENTOS ';
        Text31022901 : TextConst ENU='SEVEN HUNDRED ',PTG='SETECENTOS ';
        Text31022902 : TextConst ENU='EIGHT HUNDRED ',PTG='OITOCENTOS ';
        Text31022903 : TextConst ENU='NINE HUNDRED ',PTG='NOVECENTOS ';
        Text31022904 : TextConst ENU='TWO HUNDRED ',PTG='DUZENTOS ';
        Text31022905 : TextConst ENU='THREE HUNDRED ',PTG='TREZENTOS ';
        Text31022906 : TextConst ENU='FOUR HUNDRED ',PTG='QUATROCENTOS ';
        Text31022907 : TextConst ENU='FIVE HUNDRED ',PTG='QUINHENTOS ';
        Text31022908 : TextConst ENU='SIX HUNDRED ',PTG='SEISCENTOS ';
        Text31022909 : TextConst ENU='SEVEN HUNDRED ',PTG='SETECENTS ';
        Text31022910 : TextConst ENU='EIGHT HUNDRED ',PTG='OITOCENTOS ';
        Text31022911 : TextConst ENU='NINE HUNDRED ',PTG='NOVECENTOS ';
        Text31022912 : TextConst ENU='TEN ',PTG='DEZ ';
        Text31022913 : TextConst ENU='ELEVEN ',PTG='ONZE ';
        Text31022914 : TextConst ENU='TWELVE ',PTG='DOZE ';
        Text31022915 : TextConst ENU='THIRTEEN ',PTG='TREZE ';
        Text31022916 : TextConst ENU='FOURTEEN',PTG='CATORZE ';
        Text31022917 : TextConst ENU='FIFTEEN ',PTG='QUINZE ';
        Text31022918 : TextConst ENU='TEN  ',PTG='DEZ E ';
        Text31022919 : TextConst ENU='TWENTY ',PTG='VINTE ';
        Text31022920 : TextConst ENU='TWENTY ',PTG='VINTE E ';
        Text31022921 : TextConst ENU='THIRTY ',PTG='TRINTA ';
        Text31022922 : TextConst ENU='THIRTY ',PTG='TRINTA E ';
        Text31022923 : TextConst ENU='FORTY ',PTG='QUARENTA ';
        Text31022924 : TextConst ENU='FORTY ',PTG='QUARENTA E ';
        Text31022925 : TextConst ENU='FIFTY ',PTG='CINQUENTA ';
        Text31022926 : TextConst ENU='FIFTY ',PTG='CINQUENTA E ';
        Text31022927 : TextConst ENU='SIXTY ',PTG='SESSENTA ';
        Text31022928 : TextConst ENU='SIXTY ',PTG='SESSENTA E ';
        Text31022929 : TextConst ENU='SEVENTY ',PTG='SETENTA ';
        Text31022930 : TextConst ENU='SEVENTY ',PTG='SETENTA E ';
        Text31022931 : TextConst ENU='EIGHTY ',PTG='OITENTA ';
        Text31022932 : TextConst ENU='EIGHTY ',PTG='OITENTA E ';
        Text31022933 : TextConst ENU='NINETY ',PTG='NOVENTA ';
        Text31022934 : TextConst ENU='NINETY ',PTG='NOVENTA E ';
        Text31022935 : TextConst ENU='ONE ',PTG='UM ';
        Text31022936 : TextConst ENU='ONE ',PTG='UMA ';
        Text31022937 : TextConst ENU='TWO ',PTG='DOIS ';
        Text31022938 : TextConst ENU='THREE ',PTG='TRÊS ';
        Text31022939 : TextConst ENU='FOUR ',PTG='QUATRO ';
        Text31022940 : TextConst ENU='FIVE ',PTG='CINCO ';
        Text31022941 : TextConst ENU='SIX ',PTG='SEIS ';
        Text31022942 : TextConst ENU='SEVEN ',PTG='SETE ';
        Text31022943 : TextConst ENU='EIGHT ',PTG='OITO ';
        Text31022944 : TextConst ENU='NINE ',PTG='NOVE ';
        Text31022945 : TextConst ENU='%1 \results in a written number which is too long.',PTG='%1 \ é um número demasiado comprido.';
        Text31022946 : TextConst ENU=' ',PTG=' E ';
        Text31022947 : TextConst ENU='SIXTEEN',PTG='DEZASSEIS ';
        Text31022948 : TextConst ENU='SEVENTEEN',PTG='DEZASSETE ';
        Text31022949 : TextConst ENU='EIGHTEEN',PTG='DEZOITO ';
        Text31022950 : TextConst ENU='NINETEEN',PTG='DEZANOVE ';
        Text31022951 : TextConst ENU='ONE HUNDRED ',PTG='CENTO E ';
        Text31022952 : TextConst ENU='AND ',PTG='E ';
    ...
    begin
        ...
        IF CurrencyCode <> '' THEN BEGIN
           ...
           NdescDecimalPlaces := Currency."Curr. Dec. Unit Decimal Places";
        END ELSE BEGIN
           GLSetup.GET;
           AddToNoText(NoText,NoTextIndex,UPPERCASE(GLSetup."Currency Text") + ' ');
           NdescDecimalPlaces := GLSetup."Curr. Dec. Unit Decimal Places";
        END;
        ...
        IF DecimalPlaces > 0 THEN BEGIN
           ...
           IF CurrencyCode <> '' THEN
             AddToNoText(NoText,NoTextIndex,UPPERCASE(Currency."Currency Decimal Unit Text") + ' ')
           ELSE
