report 31023014 "Withholding Taxes"
{
    ...
    var
        ...
        IRS_IRC_RetentionCaptionLbl: Label 'Income and Withholding Summary Report ';
        Document_No_CaptionLbl: Label 'Document No.';
        IncomeCaptionLbl: Label 'Income';
        RetentionsCaptionLbl: Label 'Withholding Taxes';
        VAT_Registration_No_CaptionLbl: Label 'VAT Registration No.';
        Retention_CodeCaptionLbl: Label 'Withholding Tax Code';
