report 31023015 "Income Statement"
{
    ...
    var
        ...
        Remuneration_WorkingCaptionLbl: Label '- Remuneration Working';
        Without_RetentionCaptionLbl: Label '- Without Retention';
        With_RetentionCaptionLbl: Label '- With Retention';
        Having_been_made_the_following_deduction_CaptionLbl: Label 'Having been made the following deduction:';
        I_R_S_CaptionLbl: Label '- I.R.S.';
        CurrencyString: Label '  Eur';
