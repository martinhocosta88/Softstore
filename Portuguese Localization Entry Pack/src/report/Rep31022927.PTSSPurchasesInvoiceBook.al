report 31022927 "PTSS Purchases Invoice Book"
{
    //Livros Faturas emitidas/recebidas

    DefaultLayout = RDLC;
    RDLCLayout = './Purchases Invoice Book Layout.rdl';
    ...
    dataset
    {
        dataitem("<Integer3>"; Integer)
        {
            ...
            dataitem(VATEntry; "VAT Entry")
            {
                ...
                dataitem(DataItem1000000033; Integer)
                {
                    DataItemTableView = SORTING (Number);
            ...
            dataitem(VATEntry4; "Vat Entry")
            {
                ...
                dataitem("<Integer2>"; Integer)
                {
                    ...
                    column(VATBuffer2Amount_Control83; VATBuffer2.Amount)
                    {
                    }
    ...
    {
        PAGENO = 'Page';
        PurchasesInvoiceBook = 'Purchases Invoice Book';
