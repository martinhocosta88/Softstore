...
//                 begin
//                     SETRANGE(Number, 1, GLAcc."No. of Blank Lines");
//                 end;
//             }
...
//                 {
//                 }
//                 column(PADSTRGLAccountIndentation2GLAccountName; PADSTR('', GLAcc."Indentation" * 2) + glacc."Name")
//                 {
//                 }
//                 column(GLAccountNumber; glacc."No.")
//                 {
//                 }
...
//             trigger OnPreDataItem()
//             begin
//                 SETFILTER("No.", AccFilter);
//                 SETFILTER("Date Filter", PeriodFilter);
